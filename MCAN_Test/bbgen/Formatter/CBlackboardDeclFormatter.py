...
class CBlackboardDeclFormatter(BaseFormatter):
    ...
    def format(self, section_file: SectionFile) -> None:
        ...
        bb_decl = CFormatterSnippets.BB_DECL_FMT.format(
    ...
    def filter_applicable_variable(
        ...
        """
        getter_decl_text = CFormatterSnippets.GETTER_DECL_FMT.format(
            baseName=variable.get_full_name(),
            normalValueType=variable.get_normal_value_type())

        setter_decl_text = CFormatterSnippets.SETTER_DECL_FMT.format(
            baseName=variable.get_full_name(),
            normalValueType=variable.get_normal_value_type())
