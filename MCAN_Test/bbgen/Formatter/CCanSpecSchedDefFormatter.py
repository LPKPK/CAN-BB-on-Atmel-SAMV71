"""C CAN Specialization Definition Scheduler Formatter Class

Formatter class for the CAN specialization definition for the schedule checker in C
...
class CCanSpecSchedDefFormatter(BaseFormatter):
    """Formatter subclass for the CAN specialization definition for the schedule checker in C"""
    ...
    def format(self, section_file: SectionFile) -> None:
        """
        Formats the CAN specialization definition string for the schedule checker using the given section file object
        ...
        super().filter_applicable_messages(section_file, all_msgs=True)

        # Setup the full snippet
        can_spec_def = CFormatterSnippets.CAN_SPEC_SCHED_DEF_FMT.format(
    ...
    def filter_applicable_message(
        ...
        for var in message.variables:
            ...
            var_map_rows += CFormatterSnippets.CAN_SPEC_SCHED_DEF_VAR_MAP_ROW_FMT.format(
        ...
        self.def_list += CFormatterSnippets.CAN_SPEC_SCHED_DEF_ROW_FMT.format(
            msgId=message.id,
